...
eraser_img = cv2.imread(r'F:/Downloads/download.jpeg') 
clear_img = cv2.imread(r'F:/Downloads/clear all.png') 
...
while True:
    ...
    # Add the header image and color palette
    drawColorPalette(img)

    # Display FPS and current tool
    displayUI(img)
